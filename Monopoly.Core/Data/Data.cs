...
namespace Monopoly.Core.Data
{
    internal class Data
    {
        public static List<PropertySquare> GetPropertySquareData(GameRules gameRules)
        {
            ...
            if (gameRules.GameLanguage == GameRules.Language.UK)
            {
                data = new List<PropertySquare> {
                    new PropertySquare(LegacyPropertyGroup.Group1, "Old Kent Road", 2, 4, 10, 30, 90, 160, 250, 50, 50, 60, 30, 1),
                    new PropertySquare(LegacyPropertyGroup.Group1, "Whitechapel Road", 4, 8, 20, 60, 180, 320, 450, 50, 50, 60, 30, 3),
                    new PropertySquare(LegacyPropertyGroup.Group2, "The Angel Islington", 6, 12, 30, 90, 270, 400, 550, 50, 50, 100, 50, 6),
                    new PropertySquare(LegacyPropertyGroup.Group2, "Euston Road", 6, 12, 30, 90, 270, 400, 550, 50, 50, 100, 50, 8),
                    new PropertySquare(LegacyPropertyGroup.Group2, "Pentonville Road", 8, 16, 40, 100, 300, 450, 600, 50, 50, 120, 60, 9),
                    new PropertySquare(LegacyPropertyGroup.Group3, "Pall Mall", 10, 20, 50, 150, 450, 625, 750, 100, 100, 140, 70, 11),
                    new PropertySquare(LegacyPropertyGroup.Group3, "Whitehall", 10, 20, 50, 150, 450, 625, 750, 100, 100, 140, 70, 13),
                    new PropertySquare(LegacyPropertyGroup.Group3, "Northumberland Avenue", 12, 24, 60, 180, 500, 700, 900, 100, 100, 160, 80, 14),
                    new PropertySquare(LegacyPropertyGroup.Group4, "Bow Street", 14, 28, 70, 200, 550, 750, 950, 100, 100, 180, 90, 16),
                    new PropertySquare(LegacyPropertyGroup.Group4, "Marlborough Street", 14, 28, 70, 200, 550, 750, 950, 100, 100, 180, 90, 18),
                    new PropertySquare(LegacyPropertyGroup.Group4, "Vine Street", 16, 32, 80, 220, 600, 800, 1000, 100, 100, 200, 100, 19),
                    new PropertySquare(LegacyPropertyGroup.Group5, "The Strand", 18, 36, 90, 250, 700, 875, 1050, 150, 150, 220, 110, 21),
                    new PropertySquare(LegacyPropertyGroup.Group5, "Fleet Street", 18, 36, 90, 250, 700, 875, 1050, 150, 150, 220, 110, 23),
                    new PropertySquare(LegacyPropertyGroup.Group5, "Trafalgar Square", 20, 40, 100, 300, 750, 925, 1100, 150, 150, 240, 120, 24),
                    new PropertySquare(LegacyPropertyGroup.Group6, "Leicester Square", 22, 44, 110, 330, 800, 975, 1150, 150, 150, 260, 130, 26),
                    new PropertySquare(LegacyPropertyGroup.Group6, "Coventry Street", 22, 44, 110, 330, 800, 975, 1150, 150, 150, 260, 130, 27),
                    new PropertySquare(LegacyPropertyGroup.Group6, "Piccadilly", 24, 48, 120, 360, 850, 1025, 1200, 150, 150, 280, 150, 29),
                    new PropertySquare(LegacyPropertyGroup.Group7, "Regent Street", 26, 52, 130, 390, 900, 1100, 1275, 200, 200, 300, 150, 31),
                    new PropertySquare(LegacyPropertyGroup.Group7, "Oxford Street", 26, 52, 130, 390, 900, 1100, 1275, 200, 200, 300, 150, 32),
                    new PropertySquare(LegacyPropertyGroup.Group7, "Bond Street", 28, 56, 150, 450, 1000, 1200, 1400, 200, 200, 320, 160, 34),
                    new PropertySquare(LegacyPropertyGroup.Group8, "Park Lane", 35, 70, 175, 500, 1100, 1300, 1500, 200, 200, 350, 175, 37),
                    new PropertySquare(LegacyPropertyGroup.Group8, "Mayfair", 50, 100, 200, 600, 1400, 1700, 2000, 200, 200, 400, 200, 39),
                };
            }
            else if (gameRules.GameLanguage == GameRules.Language.US)
            {
                data = new List<PropertySquare> {
                    new PropertySquare(LegacyPropertyGroup.Group1, "Mediterranean Avenue", 2, 4, 10, 30, 90, 160, 250, 50, 50, 60, 30, 1),
                    new PropertySquare(LegacyPropertyGroup.Group1, "Baltic Avenue", 4, 8, 20, 60, 180, 320, 450, 50, 50, 60, 30, 3),
                    new PropertySquare(LegacyPropertyGroup.Group2, "Oriental Avenue", 6, 12, 30, 90, 270, 400, 550, 50, 50, 100, 50, 6),
                    new PropertySquare(LegacyPropertyGroup.Group2, "Vermont Avenue", 6, 12, 30, 90, 270, 400, 550, 50, 50, 100, 50, 8),
                    new PropertySquare(LegacyPropertyGroup.Group2, "Connecticut Avenue", 8, 16, 40, 100, 300, 450, 600, 50, 50, 120, 60, 9),
                    new PropertySquare(LegacyPropertyGroup.Group3, "St. Charles Place", 10, 20, 50, 150, 450, 625, 750, 100, 100, 140, 70, 11),
                    new PropertySquare(LegacyPropertyGroup.Group3, "States Avenue", 10, 20, 50, 150, 450, 625, 750, 100, 100, 140, 70, 13),
                    new PropertySquare(LegacyPropertyGroup.Group3, "Virginia Avenue", 12, 24, 60, 180, 500, 700, 900, 100, 100, 160, 80, 14),
                    new PropertySquare(LegacyPropertyGroup.Group4, "St. James Place", 14, 28, 70, 200, 550, 750, 950, 100, 100, 180, 90, 16),
                    new PropertySquare(LegacyPropertyGroup.Group4, "Tennessee Avenue", 14, 28, 70, 200, 550, 750, 950, 100, 100, 180, 90, 18),
                    new PropertySquare(LegacyPropertyGroup.Group4, "New York Avenue", 16, 32, 80, 220, 600, 800, 1000, 100, 100, 200, 100, 19),
                    new PropertySquare(LegacyPropertyGroup.Group5, "Kentucky Avenue", 18, 36, 90, 250, 700, 875, 1050, 150, 150, 220, 110, 21),
                    new PropertySquare(LegacyPropertyGroup.Group5, "Indiana Avenue", 18, 36, 90, 250, 700, 875, 1050, 150, 150, 220, 110, 23),
                    new PropertySquare(LegacyPropertyGroup.Group5, "Illinois Avenue", 20, 40, 100, 300, 750, 925, 1100, 150, 150, 240, 120, 24),
                    new PropertySquare(LegacyPropertyGroup.Group6, "Atlantic Avenue", 22, 44, 110, 330, 800, 975, 1150, 150, 150, 260, 130, 26),
                    new PropertySquare(LegacyPropertyGroup.Group6, "Ventnor Avenue", 22, 44, 110, 330, 800, 975, 1150, 150, 150, 260, 130, 27),
                    new PropertySquare(LegacyPropertyGroup.Group6, "Marvin Gardens", 24, 48, 120, 360, 850, 1025, 1200, 150, 150, 280, 150, 29),
                    new PropertySquare(LegacyPropertyGroup.Group7, "Pacific Avenue", 26, 52, 130, 390, 900, 1100, 1275, 200, 200, 300, 150, 31),
                    new PropertySquare(LegacyPropertyGroup.Group7, "North Carolina Avenue", 26, 52, 130, 390, 900, 1100, 1275, 200, 200, 300, 150, 32),
                    new PropertySquare(LegacyPropertyGroup.Group7, "Pennsylvania Avenue", 28, 56, 150, 450, 1000, 1200, 1400, 200, 200, 320, 160, 34),
                    new PropertySquare(LegacyPropertyGroup.Group8, "Park Place", 35, 70, 175, 500, 1100, 1300, 1500, 200, 200, 350, 175, 37),
                    new PropertySquare(LegacyPropertyGroup.Group8, "Boardwalk", 50, 100, 200, 600, 1400, 1700, 2000, 200, 200, 400, 200, 39),
                };
            }
            else
            {
        ...
        public static List<IChanceCard> GetChanceCardData(GameRules gameRules)
        {
            ...
            if (gameRules.GameLanguage == GameRules.Language.UK)
            {
                data = new List<IChanceCard> {
                    ...
                    new UKChanceCard("Go Back 3 Spaces", UKChanceCard.UKChanceCardType.GoBackThreeSpaces),
            ...
            else if (gameRules.GameLanguage == GameRules.Language.US)
            {
                data = new List<IChanceCard> {
                    ...
                    new USChanceCard("Go Back 3 Spaces", USChanceCard.USChanceCardType.GoBackThreeSpaces),
        ...
        internal static List<ChanceSquare> GetChanceSquareData(GameRules gameRules)
        {
            ...
            {
                name = "Chance ?";
                info = "Draw a chance card";
                chanceSquares.Add(new ChanceSquare(7, name, info));
                chanceSquares.Add(new ChanceSquare(22, name, info));
                chanceSquares.Add(new ChanceSquare(36, name, info));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
        ...
        internal static List<CommunityChestSquare> GetCommunityChestSquareData(GameRules gameRules)
        {
            ...
            if (gameRules.GameLanguage == GameRules.Language.UK || gameRules.GameLanguage == GameRules.Language.US)
            {
                ...
                info = "Draw a community chest card";
                communityChestSquares.Add(new CommunityChestSquare(2, name, info));
                communityChestSquares.Add(new CommunityChestSquare(17, name, info));
                communityChestSquares.Add(new CommunityChestSquare(33, name, info));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
        ...
        internal static List<GoSquare> GetGoSquareData(GameRules gameRules)
        {
            ...
            {
                name = "GO";
                info = $"Collect salary as you pass GO";
                goSquares.Add(new GoSquare(position, name, info));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
        ...
        internal static List<GoToJailSquare> GetGoToJailSquareData(GameRules gameRules)
        {
            ...
            {
                name = "Go To Jail";
                info = "Go to jail! Do not collect salary";
                goToJailSquares.Add(new GoToJailSquare(position, name, info));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
        ...
        internal static List<JailSquare> GetJailSquareData(GameRules gameRules)
        {
            ...
            if (gameRules.GameLanguage == GameRules.Language.UK || gameRules.GameLanguage == GameRules.Language.US)
            {
                ...
                info = "Visiting Jail";
                InJailInfo = "In Jail";
                jailSquares.Add(new JailSquare(Position, name, info, InJailInfo));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
        ...
        internal static List<ParkingSquare> GetParkingSquareData(GameRules gameRules)
        {
            ...
            {
                name = "Free Parking";
                parkingSquares.Add(new ParkingSquare(position, name));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
        ...
        internal static List<TaxSquare> GetTaxSquareData(GameRules gameRules)
        {
            ...
            {
                info = "Pay tax";
                taxSquares.Add(new TaxSquare(4, 200, "Income Tax", info));
                taxSquares.Add(new TaxSquare(38, 100, "Luxury Tax", info));
            }
            else
            {
                throw new ArgumentException("Unsupported language");
